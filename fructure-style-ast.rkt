...
(require "fructure-language.rkt"
         "fructure-utility.rkt"
         (for-syntax racket/match racket/list racket/syntax racket/function
...
(begin-for-syntax
  (define stylesheet '(((◇ (▹ hole))
                       ...
                       ; danger! we're not checking sorts, what follows is fallthrough!!
                       #; ((◇ (free ...))
  ...
  (define form-list->pattern (compose (curry map-rec redotdotdot)
                                      make-style-pattern
